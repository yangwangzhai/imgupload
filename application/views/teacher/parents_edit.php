                ...
                <div class="panel-body">
                    ...
                    <table class="table table-condensed  stafftable">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text"  id="studentname"
                                       value="<?php echo $value['studentname']?>" class="form-control"/>
                                <input type="hidden" name="value[studentid]" id="studentid" value="<?php echo $value['studentid']?>">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="value[experience]" class="form-control">
                                    <?=getSelect(config_item('experience'),$value['experience'])?></select>
                            </td>
                            <th>配合程度</th>
                            <td>
                                <select name="value[fit]" class="form-control">
                                    <?=getSelect(config_item('fit'),$value['fit'])?></select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="value[transport]" class="form-control">
                                    <?=getSelect(config_item('transport'),$value['transport'])?></select>
                            </td>
                            <th>家庭环境</th>
                            <td>
                                <select name="value[environment]" class="form-control">
                                    <?=getSelect(config_item('environment'),$value['environment'])?></select>
                            </td>
                        ...
                        <tr>
                            ...
                            <th>参与活动次数</th>
                            <td>
                                <input type="text" name="value[activities]" value="<?php echo $value['activities']?>" class="form-control">
                            </td>
                        </tr>
                        <tr>
                            <th>手机号码<font color="red">*</font></th>
                            <td>
                                <input name="value[tel]" type="text" value="<?php echo $value['tel']?>" class="form-control">
                            </td>
                            <th>电子邮箱</th>
                            <td>
                                <input name="value[email]" value="<?php echo $value['email']?>" type="text" class="form-control">
                            </td>
                        </tr>
                        <tr>
                            <th>工作单位</th>
                            <td>
                                <input name="value[company]" type="text" value="<?php echo $value['company']?>" class="form-control">
                            </td>
                            <th>家庭住址</th>
                            <td>
                                <input name="value[address]" type="text" value="<?php echo $value['address']?>" class="form-control">
                            </td>
                        ...
                        <tr>
                            <th>籍 贯</th>
                            <td>
                                <input name="value[place]" value="<?php echo $value['place']?>" type="text" class="form-control">
                            </td>
                            <th>个性签名</th>
                            <td>
                                <input name="value[sign]" type="text" value="<?php echo $value['sign']?>" class="form-control">
                            </td>
                                        ...
                                        <tr align="left">
                                            ...
                                            <?php foreach($item as $val):?>
                                                <td width="20px"><input name="volunteer[]" type="checkbox" id="checkbox" value="<?=$val['id']?>"
                                                        <?=in_array($val['id'], $volunteer)?'checked="checked"':''?>
                                                        /><?=$val['title']?></td>&nbsp;&nbsp;&nbsp;
                                            <?php endforeach;?>
                                        </tr>
                                    <?php endforeach;?>
                        ...
                        <tr>
                            ...
                            <th>备 注</th>
                            <td class="td_right" colspan="3">
                                <textarea name="value[content]" rows="2" cols="20"  class="form-control" style="height:100px;width:600px;"><?php echo $value['content']?></textarea>
