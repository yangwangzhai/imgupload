                ...
                <div class="panel-body">
                    ...
                    <table class="table table-condensed  stafftable">
                        ...
                        <tbody><tr>
                            ...
                            <td width="30%">
                                <input readonly value="<?php echo $value['nickname']?>" type="text"  class="form-control">
                                <input type="hidden" name="value[classid]" value="<?php echo $value['classid']?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="value[name]" type="text" value="<?php echo $value['name']?>"  class="form-control">
                        ...
                        <tr>
                            <th>家庭住址</th>
                            <td>
                                <input name="value[address]" value="<?php echo $value['address']?>" type="text" id="tel" class="form-control">

                            </td>

                            <th>住宅电话</th>
                            <td>
                                <input name="value[tel]" value="<?php echo $value['tel']?>" type="text" class="form-control">
                        ...
                        <tr>
                            ...
                            <th>有无疾病史</th>
                            <td>
                                <input name="value[allergic]" value="<?php echo $value['allergic']?>" type="text" class="form-control">
                            </td>

                            <th>择园原因</th>
                            <td>
                                <select name="value[reason]" class="form-control">
                                    <?=getSelect(config_item('reason'),$value['reason'])?></select>
                ...
                <div class="panel-body">
                    <table class="table table-condensed  stafftable">
                        ...
                        <tbody><tr>
                            <th>英文名</th>
                            <td>
                                <input name="value[engname]" type="text" value="<?=$value['engname']?>" class="form-control">
                            </td>
                            ...
                            <td width="30%">
                                ...
                                <table id="" border="0" style="border-width:0px;width:150px;">
                                    <tbody><tr>
                                        <td><input id="b1" type="radio" name=value[child]"  value="1" <?php if($value['child']==1) echo 'checked'?>><label for="b1">是</label></td>
                                        <td><input id="b2" type="radio" name=value[child]"  value="2" <?php if($value['child']==2) echo 'checked'?>><label for="b2">不是</label></td>
                                    </tr>
                                    </tbody></table>
                        ...
                        <tr>
                            ...
                            <td width="30%">
                                ...
                                <table id="" border="0" style="border-width:0px;width:150px;">
                                    <tbody><tr>
                                        <td><input id="c1" type="radio" name=value[workers]"  value="1" <?php if($value['workers']==1) echo 'checked'?>><label for="c1">是</label></td>
                                        <td><input id="c2" type="radio" name=value[workers]"  value="2" <?php if($value['workers']==2) echo 'checked'?>><label for="c2">不是</label></td>
                                    </tr>
                                    </tbody></table>
                        ...
                        <tr>
                            <th>身份证件号码</th>
                            <td>
                                <input type="text" name="value[idcard]" value="<?=$value['idcard']?>" class="form-control" />
                            </td>
                            ...
                            <td width="30%">
                                ...
                                <table id="" border="0" style="border-width:0px;width:150px;">
                                    <tbody><tr>
                                        <td><input id="d1" type="radio" name=value[stay]"  value="1" <?php if($value['stay']==1) echo 'checked'?>><label for="d1">是</label></td>
                                        <td><input id="d2" type="radio" name=value[stay]"  value="2" <?php if($value['stay']==2) echo 'checked'?>><label for="d2">不是</label></td>
                                    </tr>
                                    </tbody></table>
                        ...
                        <tr>
                            ...
                            <td width="30%">
                                ...
                                <table id="" border="0" style="border-width:0px;width:150px;">
                                    <tbody><tr>
                                        <td><input id="e1" type="radio" name=value[support]"  value="1" <?php if($value['support']==1) echo 'checked'?>><label for="e1">是</label></td>
                                        <td><input id="e2" type="radio" name=value[support]"  value="2" <?php if($value['support']==2) echo 'checked'?>><label for="e2">不是</label></td>
                                    </tr>
                                    </tbody></table>
                            ...
                            <td width="30%">
                                ...
                                <table id="" border="0" style="border-width:0px;width:150px;">
                                    <tbody><tr>
                                        <td><input id="f1" type="radio" name=value[allowances]"  value="1" <?php if($value['allowances']==1) echo 'checked'?>><label for="f1">是</label></td>
                                        <td><input id="f2" type="radio" name=value[allowances]"  value="2" <?php if($value['allowances']==2) echo 'checked'?>><label for="f2">不是</label></td>
                                    </tr>
                                    </tbody></table>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="value[account]" class="form-control">
                                    <?=getSelect(config_item('account'),$value['account'])?></select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="30%">
                                ...
                                <table id="" border="0" style="border-width:0px;width:150px;">
                                    <tbody><tr>
                                        <td><input id="g1" type="radio" name=value[disabled]"  value="1" <?php if($value['disabled']==1) echo 'checked'?>><label for="g1">是</label></td>
                                        <td><input id="g2" type="radio" name=value[disabled]"  value="2" <?php if($value['disabled']==2) echo 'checked'?>><label for="g2">不是</label></td>
                                    </tr>
                                    </tbody></table>
                        ...
                        <tr>
                            ...
                            <td width="30%">
                                ...
                                <table id="" border="0" style="border-width:0px;width:150px;">
                                    <tbody><tr>
                                        <td><input id="h1" type="radio" name=value[boarding]"  value="1" <?php if($value['boarding']==1) echo 'checked'?>><label for="h1">是</label></td>
                                        <td><input id="h2" type="radio" name=value[boarding]"  value="2" <?php if($value['boarding']==2) echo 'checked'?>><label for="h2">不是</label></td>
                                    </tr>
                                    </tbody></table>
                            ...
                            <td>
                                <select name="value[disabled_type]" class="form-control">
                                    <?=getSelect(config_item('disabled_type'),$value['disabled_type'])?></select>
                        ...
                        <tr>
                            ...
                            <td>
                                <table id="" border="0" style="border-width:0px;width:150px;">
                                    <tbody><tr>
                                        <td><input id="i1" type="radio" name=value[orphans]"  value="1" <?php if($value['orphans']==1) echo 'checked'?>><label for="i1">是</label></td>
                                        <td><input id="i2" type="radio" name=value[orphans]"  value="2" <?php if($value['orphans']==2) echo 'checked'?>><label for="i2">不是</label></td>
                                    </tr>
                                    </tbody></table>
