                ...
                <div class="panel-body">
                    ...
                    <table class="table table-condensed  stafftable">
                        ...
                        <tbody><tr>
                            ...
                            <td width="30%">
                                <input type="text" class="form-control"
                                     readonly  value="<?php echo $value['truename']?>" />
                                <input type="hidden" class="txt" name="value[uid]" id="teacherid"
                                       value="<?php echo $value['uid']?>" />
                            </td>
                            <th ></th>
                            <td>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="value[leave_type]" class="form-control">
                                    <?=getSelect(config_item('leave_type'),$value['leave_type'])?>
                                </select>
                            </td>
                            <th ></th>
                            <td>
                                    ...
                                    <tbody><tr>
                                        <td>
                                            ...
                                            <select name="value[hournum]" class="form-control" style="width: 40%; display: inline">
                                                <?=getSelect($hournums,$value['hournum'])?>
                                            </select>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <tr>
                            ...
                            <td class="td_right" colspan="3">
                                <textarea name="value[content]" rows="2" cols="20"  class="form-control" style="height:150px;width:100%;"><?php echo $value['content']?></textarea>
