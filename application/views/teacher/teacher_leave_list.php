        ...
        <form action="<?=$this->baseurl?>&m=delete" method="post">
            <table width="99%" border="0" cellpadding="3" cellspacing="0"
                ...
                <tr>
                    ...
                    <th width="60">请假者</th>
                    <th width="100">假别</th>
                    <th width="300">假期与原因</th>
                    <th width="100">管理员回复</th>
                ...
                <?php foreach($list as $key=>$r) {?>
                    <tr class="sortTr">
                        ...
                        <td><?=$r['truename']?></td>
                        <td><?=$r['leave_type']?></td>
                        <td><?=' 假期:'.$r['starttime'].'~'.$r['endtime'].'(<font color="green">'.$r['daynum'].'天'.$r['hournum'].'小时</font>)'?>
                            <br>
                            原因:<?=$r['content']?>
                        </td>
                        <td><?=$r['reply']?></td>
                        ...
                        <td>
                            ...
                            <a href="<?=$this->baseurl?>&m=delete&id=<?=$r['id']?>"
                                onclick="return confirm('确定要删除吗？');">销假</a></td>
                    </tr>
                <?php }?>
                <tr>
